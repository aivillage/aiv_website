...
const learnResources = defineCollection({
  ...
  schema: z
    .object({
      ...
      episodeOrder: z.number().optional(),
      recommendedRole: z.enum(["primary", "required", "optional", "deeper", "featured", "supplemental", "link_only"]).optional(),
      watchFocus: z.string().optional(),
      checkpointPrompt: z.string().optional(),
      reviewStatus: z.enum(["accepted", "needs_verification", "human_review", "deferred", "rejected"]).optional(),
