...
export const kioskSlides: KioskSlide[] = [
  ...
  { type: "poster", id: "poster-2" },
  {
    ...
    url: "http://llm-embeddings.lab.aivillage.local/",
    duration: 27000,
  ...
  { type: "poster", id: "poster-3" },
  {
    ...
    url: "http://email-indirect.lab.aivillage.local/",
    duration: 27000,
    requiresWorkshops: true,
  },
  { type: "brand", id: "interlude" },
  {
    ...
    id: "rag-poisoning",
    title: "RAG Poisoning",
    url: "http://rag-poisoning.lab.aivillage.local/",
    duration: 27000,
    requiresWorkshops: true,
  },
  { type: "poster", id: "poster-4" },
  {
    ...
    url: "http://prompt-extraction.lab.aivillage.local/",
    duration: 27000,
    requiresWorkshops: true,
  },
  {
    ...
    id: "model-lab",
    title: "Model Lab",
    url: "http://model-lab.lab.aivillage.local/?presentation=spatial&demo=1",
    duration: 165000,
    requiresWorkshops: true,
  },
];
