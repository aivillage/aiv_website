...
export const posters: Poster[] = [
  {
    ...
    authors: [
      {
        name: "Utku Yildirim",
        affiliation: "Cobalt.io & Hoffmann Cybersecurity",
      },
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1ms39W56OgrB0K3zuxXkSiba4Pwpr86v6/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [{ name: "Emile Delcourt", affiliation: "OWASP ASI" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1FFh8L6_cuE7KRDZ8i-YwmiwHqdMq1dNU/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [{ name: "Raz Tel-Vered", affiliation: "Zenity" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/11kec4Qr0aJXkyI8o1MD-Ra6IZ4Bvr7FS/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1cXykSlnfD1D5Xeu0QjOBHk22y28MS81i/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [{ name: "Rodney Beede", affiliation: "Life360" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/129NfqgqlC6BKrE1772qsRZSIRQu-GHLk/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/13G_1UFRkhnVnmJX3ueZVWCzmiL-5HMbo/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1wHDobyEBiGq5CXzaTYVeGGrpLcuFqMtI/view?usp=drive_link",
  ...
  },
  {
    ...
    abstract:
      "In this talk we move past the AI agent hype by sharing Google’s battle-tested engineering blueprint for deploying autonomous security agents to defend a global enterprise. It explores the technical realities of this transition, including evaluating non-deterministic AI behavior, choosing between agent architectures, and integrating autonomous entities into high-stakes threat detection workflows.",
  },
  {
    ...
    authors: [{ name: "Willie Zhang", affiliation: "ProCircular" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1WF7E1XQnKobXb6-mIGGqrwq98Iehw8vr/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [
      {
        name: "Veli Oguzcan Akdag",
        affiliation: "Bilishim Cyber Security & AI",
      },
    ],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1j2yHo4PyMi2nkj-efo7ACXvhyqY2JcAy/view?usp=sharing",
  ...
  },
  {
    ...
    authors: [
      { name: "John Kotheimer", affiliation: "Google" },
      {
        ...
        affiliation: "Google, @danieldibartolo (Twitter)",
      },
    ],
    abstract:
      "Google operates the AI Vulnerability Reward Program (AI VRP), a bug bounty program focused on security vulnerabilities and specific abuse risks in Google's generative AI products. These include sensitive data exfiltration and rogue actions impacting user security caused by indirect prompt injection in AI products. The AI VRP provides security benefits to Google's users by providing a venue for responsible disclosure of security bugs and enables Google's security teams to understand emerging risks and attack patterns affecting AI. In establishing this program, we have also learned how best to structure it to provide actionable information to product teams while also maintaining a healthy researcher community.",
  },
  {
    ...
    authors: [{ name: "Dan Lisichkin", affiliation: "Pillar Security" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1dgQXJRa5PGyOlLzjihvr6I0NbFliBBFG/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1ZEhLs8bq7IsVRpTyFX0UPZak4N-HzWAh/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [
      {
        name: "Roshan Piyush",
        affiliation: "Harness of Security Research @ Harness",
      },
      {
        name: "Soujanya Namburi",
        affiliation: "Senior Security Researcher @ Harness",
      },
    ],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1PH9IM3GjineCMvTk6SdgI-frDZmVOolJ/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1eF9v0lqa_rwG25hQyWXzggNA8gUwucRt/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1jqap8e7pTx0smzSUOm6WK3PXif01dEH8/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [{ name: "John Seymour", affiliation: "Salesforce" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1qkO71SdsClFCjqfmaP4qdPjwRK6vfdk2/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1OdjYXqaEmFK3fkqCuTPMlZ4Zis8oo4H6/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/10W_HshKMlk-CAM8FRCnTEW8cLpFmsGLA/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1sF_O_aYgR85bMDRSeZFZoxv74zV-wfKV/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1eJ6HA2u2pq0-csk7eAYmAjhPo1ynngC1/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1_7BZTUkcGmu4eb2X05eYidZwKWZi9S0W/view?usp=drive_link",
  ...
  },
  {
    ...
    authors: [{ name: "David Kuznicki", affiliation: "Puzzled Hackers" }],
    abstract:
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1SWqDt4TwJqRw3tTGGp-DU59a_UA4vkiv/view?usp=drive_link",
  ...
  },
  {
    ...
    sourceUrl:
      "https://drive.google.com/file/d/1T1qQi24n2Mbem5jVxkdvCUEh5zgVo6i3/view?usp=drive_link",
  ...
  },
  {
    ...
    posterAvailability: "hosted",
    title:
      "The Weight of Evidence: How an Agentic SOC Analyst Earns Your Trust",
    authors: [{ name: "Sophena Wilson", affiliation: "Microsoft" }],
    abstract:
